...
int scull_p_init(dev_t firstdev)
{
	...
	result = register_chrdev_region(firstdev, scull_p_nr_devs, "myScullp");
	if (result < 0) {
...
#ifdef SCULL_DEBUG
	create_proc_read_entry("myScullpipe", 0, NULL, scull_read_p_mem, NULL);
#endif
...
#ifdef SCULL_DEBUG
	remove_proc_entry("myScullpipe", NULL);
#endif
